    if game.CoreGui:FindFirstChild("SOMEXHUBMODILE") then
        ...
        MODILEGUISOMEXHUB.BackgroundColor3 = Color3.fromRGB(0,255,0)
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=91556276394723"
do
...
function library:AddWindow(text,logo,keybind)
	...
	BindButton.BackgroundColor3 = Color3.fromRGB(0,255,0)
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(0,255,0)
	...
	function uitab:AddTab(text)
		...
		function main:AddDropdown(text,option,callback)
			...
			DropTitle.BackgroundColor3 = Color3.fromRGB(0,255,0)
			...
			DropImage.BackgroundColor3 = Color3.fromRGB(0,255,0)
		...
		function main:AddSlider(text,min,max,set,callback)
			...
			SliderLabel.BackgroundColor3 = Color3.fromRGB(0,255,0)
			...
			HAHA.Name = "HAHA"
			HAHA.Parent = sliderr
			HAHA.BackgroundColor3 = Color3.fromRGB(0,255,0)
			HAHA.BackgroundTransparency = 1.000
			HAHA.Size = UDim2.new(0, 468, 0, 29)

			AHEHE.Name = "AHEHE"
			AHEHE.Parent = sliderr
			AHEHE.BackgroundColor3 = Color3.fromRGB(0,255,0)
		...
		function main:AddTextbox(text,disappear,callback)
			...
			txtbtn.BackgroundColor3 = Color3.fromRGB(0,255,0)
		...
		function main:AddSeperator(text)
			...
			Sep2.Text = text
			Sep2.TextColor3 = Color3.fromRGB(0,255,0)
...
function BTP(p)
    ...
    --------------------------------------------------------------------
local win = library:AddWindow("MinGaming Hub","Make By HDROBLOX",Enum.KeyCode.RightControl)
--Tab
Main = win:AddTab("Main")
Set = win:AddTab("Settings")
    Main:AddSeperator("Main")
    local SelectWeapon = Main:AddDropdown("Select Weapon"),ChooseWeapon = Value,function(value)
        ChooseWeapon = Value
    end)
    task.spawn(function()
        while wait() do
    ...
    local AutoFarm = Main:AddToggle("Auto Farm Level",_G.LevelFarm = Value,function(value)
        _G.LevelFarm = Value
    end)
    ...
    Settings:AddSeperator("Settings")
